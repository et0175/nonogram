...
- **Flow**: Flow 1
- **Input**: landscape.png (60×40px — a synthetic fixture: black outer
  sixths and a centred core, generated by `tests/fixtures/make_fixtures.py`.
  It was described here as a 2000×1000 photograph, which never existed in
  this repository; CARD-087.)
