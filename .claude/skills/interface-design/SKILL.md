...
description: Craft-first interface design for dashboards, admin panels, SaaS apps, tools, settings pages, data interfaces, and interactive products. Use when designing, building, reviewing, auditing, or refining product UI where visual craft, layout hierarchy, tokens, states, visual direction, image-based references, or design-system consistency matter. Not for marketing pages, landing pages, campaigns, or brand-only work. Use when asked to "review my UI", "check accessibility", "create prototype", "review UX", "design the UI", "design a prototype", "audit design", or "check my site against best practices".
---
...
Run this layer before any visual or structural thinking. Skip if research is already done or the design direction is confirmed.

## User Research

Understanding users before designing for them.
- Identify user needs and pain points through interviews, surveys, and observation
- Define personas and jobs-to-be-done to keep design grounded
- Base decisions on evidence, not assumptions

## Information Architecture

Structuring information so users can find what they need.
- Navigation design, menus, and categorisation
- Consistent labelling and naming conventions
- Search experiences and wayfinding
- Goal: reduce cognitive load and improve findability

## User Flows

Map how a user moves from point A to point B before jumping to high-fidelity screens.
- Identify decision points, dead ends, and happy paths
- Validate flows against real user tasks before implementation

## Analytical Lens

- Analyse usability test results and identify friction points
- Review user behaviour metrics (drop-off rates, rage clicks)
- Measure design effectiveness against defined success criteria

## Advocacy

- Recognise user frustrations before they surface as support tickets
- Push back on feature requests that add complexity without user value
- Champion accessibility as a baseline, not an add-on
